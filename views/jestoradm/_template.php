...
<head>
    ...
    <link rel="stylesheet" href="<?= asset("css/custom.css", "jestoradm"); ?>" />
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-sidebar sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-3">Jestor</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= $router->route("tickets.home") ;?>">
            ...
            <li class="nav-item mt-5"><a class="nav-link" href="<?= $router->route("app.logoff"); ?>"
    ...
    <script src="<?= asset("js/jquery-ui.js", "jestoradm"); ?>"></script>
    <script src="<?= site(); ?>/_cdn/js/bootstrap.bundle.min.js"></script>
    <script src="<?= asset("js/form.js", "jestoradm"); ?>"></script>
