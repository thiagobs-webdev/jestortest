<?php $v->layout("jestorweb/Auth/_template");?>

<?php $v->start("css"); ?>
<link rel="stylesheet" href="<?= asset("css/floating-labels.css", "jestorweb/Auth"); ?>" />
<?php $v->end(); ?>
...
<form class="form-signin" action="<?= $router->route("auth.login"); ?>" method="post" autocomplete="off">
    ...
    <h3 class="text-center text-white py-2">Jestor Login</h3>
...
<input type="checkbox" value="remember-me"> Remember me
    ...
    <div class="py-3 my-4 text-center border-top text-light">
        ...
        <p class="py-3">
            ...
            <a href="<?= $router->route("web.register");?>" class="btn btn-sm btn-outline-primary">
                Cadastre-se agora
            </a>
        </p>
