...
class Web extends Controller
{
    ...
    public function home(): void
    {
        $head = $this->seo->optimize(
            ...
            routeImage("Jestor Tickets")
        )->render();

      
        echo $this->view->render("jestorweb/home", [
            "head" => $head
        ]);
    }
    ...
    public function register(): void
    {
        ...
        echo $this->view->render("jestorweb/Auth/register", [
            "head" => $head,
            "user" => $form_user
        ]);
    }
    ...
    public function login(): void
    {
        ...
        echo $this->view->render("jestorweb/Auth/login", [
            "head" => $head
        ]);
    }
    ...
    public function forget(): void
    {
        ...
        echo $this->view->render("jestorweb/Auth/forget", [
            "head" => $head
        ]);
    }
    ...
    public function reset(array $data): void
    {
        ...
        echo $this->view->render("jestorweb/Auth/reset", [
            "head" => $head
        ]);
    }
